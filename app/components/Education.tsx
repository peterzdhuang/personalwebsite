        ...
        <div className="relative border-l border-gray-200 pl-4">
          {education.map((edu, index) => (
            <div key={index} className="mb-8 ml-6">
              ...
              <div className="p-4 bg-white rounded-lg border border-gray-200 shadow-md transition-all duration-300 hover:shadow-md hover:border-gray-300 hover:bg-gray-50">
